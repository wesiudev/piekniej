...
export const Contact = ({
  ...
  return (
    <div
      className={`sm:shadow-sm  font-sans min-h-[90vh] sm:min-h-[60vh] pt-6 sm:shadow-black w-full sm:w-2/3 lg:w-1/2  bg-gradient-to-br from-rose-400 to-red-400 sm:rounded-l-md fixed top-0 sm:top-[50%] right-0 z-50 sm:-translate-y-[50%] ease-in-out duration-[250ms] flex items-center justify-center lg:pt-6 
        ${transitionState}}
        `}
    >
