  ...
  return (
    <div className="flex flex-col w-full h-full p-6 ">
      <div className="relative h-max w-full">
        <input
          className={`p-3 outline-none focus:shadow-md focus:shadow-rose-500 w-full z-5`}
          type="email"
      ...
      <div className="text-red-600">
        {isError.email && "Wpisz poprawny email"}
      </div>
      <div className="relative h-full w-full mt-9">
        <textarea
          className="p-3 outline-none focus:shadow-md focus:shadow-rose-500 w-full z-5 resize-none h-full"
          onFocusCapture={() => {
