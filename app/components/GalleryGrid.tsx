    ...
    <div className="bg-gradient-to-b from-rose-300 via-rose-200 to-rose-300 w-full">
      <div className="w-full h-max flex justify-center py-12 ">
        <div className="h-max w-[90vw] flex flex-col justify-center">
          <span className="flex flex-row items-center text-3xl font-sans text-gray-50 sm:py-6 drop-shadow-lg shadow-black py-12 justify-center sm:justify-start">
            Manicure - moje prace{" "}
            <FaArrowCircleRight className="ml-2 hidden sm:block" />
          </span>
      ...
      <div className="w-full flex justify-center pt-12 sm:pt-6">
        <Link
          href="instagram.com"
          className="w-max p-3 bg-rose-400 font-sans text-xl text-white flex flex-row items-center group border-2 border-transparent hover:border-white rounded-lg"
        >
          Zobacz więcej{" "}
